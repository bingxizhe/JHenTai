...
class zh_TW {
  static Map<String, String> keys() {
    return {
      ...
      'deleteHistoryVersionsHint': '按完整祖先鏈分組，而非按名稱分組。即使中間版本已刪除也能關聯。可使用深度掃描查找遠端關聯。',
      ...
      'linkedVersion': '已關聯',
      'loadingGalleriesProgress': '正在載入畫廊 {count}/{total}',
      'fetchOldVersionUrls': '取得歷史版本連結',
      'fetchOldVersionUrlsHint': '連網取得所有下載畫廊的完整祖先鏈（父版本、祖父版本……），用於「刪除歷史版本」功能識別跨多跳的版本關係。舊格式的單連結記錄會自動升級為完整祖先鏈。先使用表站，失敗則使用裏站，再失敗則輸出失敗項。',
      'fetchOldVersionUrlsProgress': '正在取得 {count}/{total}',
      'fetchOldVersionUrlsDone': '完成：更新 {updated} 個，失敗 {failed} 個',
      'updatedCount': '已更新',
      'failedItems': '失敗項',
      'retryFailed': '重試失敗部分',
      'failedGallerys': '失敗畫廊',
