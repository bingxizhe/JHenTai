...
class ko_KR {
  static Map<String, String> keys() {
    return {
      ...
      'deleteHistoryVersionsHint': '이름이 아닌 완전한 조상 체인으로 그룹화합니다. 중간 버전이 삭제되어도 작동합니다. 심층 스캔으로 원격 링크를 찾을 수 있습니다.',
      ...
      'linkedVersion': '연결됨',
      'loadingGalleriesProgress': '갤러리 로딩 중 {count}/{total}',
      'fetchOldVersionUrls': '이전 버전 링크 가져오기',
      'fetchOldVersionUrlsHint': '모든 다운로드 갤러리의 완전한 조상 체인(부모, 조부모, …)을 EH에서 가져와 "이전 버전 삭제"가 다중 홉 관계를 그룹화할 수 있도록 합니다. 기존 단일 URL 레코드는 자동으로 전체 체인으로 업그레이드됩니다. e-hentai 먼저 시도, 실패 시 exhentai, 그 후 실패로 기록.',
      'fetchOldVersionUrlsProgress': '가져오는 중 {count}/{total}',
      'fetchOldVersionUrlsDone': '완료: {updated} 업데이트, {failed} 실패',
      'updatedCount': '업데이트됨',
      'failedItems': '실패 항목',
