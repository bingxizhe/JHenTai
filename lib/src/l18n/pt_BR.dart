...
class pt_BR {
  static Map<String, String> keys() {
    return {
      ...
      'deleteHistoryVersionsHint': 'Agrupa por cadeia completa de ancestrais, não por nome. Funciona mesmo se versões intermediárias foram excluídas. Use verificação profunda para encontrar links remotos.',
      ...
      'loadingGalleriesProgress': 'Carregando galerias {count}/{total}',
      'fetchOldVersionUrls': 'Buscar Links de Versões Anteriores',
      'fetchOldVersionUrlsHint': 'Buscar a cadeia completa de ancestrais (pai, avô, …) do EH para todas as galerias baixadas, permitindo que "Excluir Versões Anteriores" agrupe relações de vários saltos. Registros legados de URL único são atualizados automaticamente para a cadeia completa. Tenta e-hentai primeiro, depois exhentai, depois registra falhas.',
      'fetchOldVersionUrlsProgress': 'Buscando {count}/{total}',
      'fetchOldVersionUrlsDone': 'Concluído: {updated} atualizados, {failed} falhas',
