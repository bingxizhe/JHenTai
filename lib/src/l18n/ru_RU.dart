...
class ru_RU {
  static Map<String, String> keys() {
    return {
      ...
      'deleteHistoryVersionsHint': 'Группировка по полной цепочке предков, а не по названию. Работает даже если промежуточные версии удалены. Используйте глубокое сканирование для поиска удалённых связей.',
      ...
      'loadingGalleriesProgress': 'Загрузка галерей {count}/{total}',
      'fetchOldVersionUrls': 'Получить ссылки на старые версии',
      'fetchOldVersionUrlsHint': 'Получить полную цепочку предков (родитель, прародитель, …) из EH для всех загруженных галерей, чтобы «Удалить предыдущие версии» мог группировать связи через несколько переходов. Записи с одним URL обновляются до полной цепочки автоматически. Сначала e-hentai, затем exhentai, затем записи ошибок.',
      'fetchOldVersionUrlsProgress': 'Получение {count}/{total}',
      'fetchOldVersionUrlsDone': 'Готово: обновлено {updated}, ошибок {failed}',
